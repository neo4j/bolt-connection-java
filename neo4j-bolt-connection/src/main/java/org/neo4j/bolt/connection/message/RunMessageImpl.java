...
record RunMessageImpl(String query, Map<String, Value> parameters, RunMessage.Extra rawExtra) implements RunMessage {

    @Override
    public Optional<RunMessage.Extra> extra() {
