...
public class PooledBoltConnection implements BoltConnection {
    ...
    private final PooledBoltConnectionSource boltConnectionSource;
    ...
    public PooledBoltConnection(
        ...
        this.boltConnectionSource = Objects.requireNonNull(boltConnectionSource);
    ...
    public CompletionStage<Void> writeAndFlush(ResponseHandler handler, List<Message> messages) {
        return delegate.writeAndFlush(new PooledResponseHandler(boltConnectionSource, handler), messages)
