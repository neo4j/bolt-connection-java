...
public class BoltProtocolV6 extends BoltProtocolV58 {
    public static final BoltProtocolVersion VERSION = new BoltProtocolVersion(6, 0);
    public static final BoltProtocol INSTANCE = new BoltProtocolV6();

    @Override
    public MessageFormat createMessageFormat() {
        return new MessageFormatV6();
    }
